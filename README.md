...
This framework has used mock numbers for political factors that can be considered as not exact, please check the needs of your research before reusing, this is adapted to the UK in 2023 and the sititation going on since brexit.

Please for more insights check the first file on this repo
